package com.stevdza_san.rewardsystemapp.util.ads
...
fun detectAdConfiguration(context: Context) : AdConfiguration {
    ...
    val goodVendorConfiguration = ""
...
fun outputVendorString(context: Context) {
    val sp = PreferenceManager.getDefaultSharedPreferences(context)
    val tcVendorString = sp.getString("IABTCF_VendorConsents", null)
    Log.d("VendorString", tcVendorString ?: "not stored")
}